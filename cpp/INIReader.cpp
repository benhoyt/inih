...
const std::string INIReader::Get(const std::string& section, const std::string& name, const std::string& default_value)
{
...
const std::string INIReader::MakeKey(const std::string& section, const std::string& name)
{
